...
//    Merchandise(id:24,name:"Accesories new Arrival",image:"https://picsum.photos/250?image=1",price: "75000",category: 3),
  ...
  String _subCategorySelected = 'All';
  ...
  setByCateogory(String category){
    _subCategorySelected = 'All';
    if(category == 'All'){
      reset();
    }else {
  ...
  setBySubCategory(String subCategory){
    _subCategorySelected = subCategory;
    if(_subCategorySelected != 'All')
...
class Merchandise{
  ...
  String category;
  String subCategory;
  Merchandise({this.id, this.name, this.image, this.price, this.category, this.subCategory});
}